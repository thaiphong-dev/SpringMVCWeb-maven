			...
			<div class="box-header-01">
						...
						<div class="box-main-menu">
							<div class="main-menu">
								<ul>
									...
									<div class="image"><img alt="" src= "<c:url value='/assets/images/feature-mega01.png' />" /></div>
									...
									<div class="content"><img alt="" src= "<c:url value='/assets/images/sale-mega-01.png' />" />
			   ...
			   <div class="item-wrap">
				  <div class="item-image">
						 ...
						 <img class="first_image" src="<c:url value='/assets/images/product/larg/demo9.jpg' />" alt="Product demo" /> 
						 </a>
						 <div class="item-btn">
							<div class="box-inner">
													   ...
													   <!--end item wrap -->
														...
														<div class="item">
														   ...
														   <div class="item-wrap">
															  <div class="item-image">
																	 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
																	 <img class="first_image" src="<c:url value='/assets/images/product/larg/demo6.jpg' />" alt="Product demo" /> 
																	 </a>
																	 <div class="item-btn">
																		<div class="box-inner">
																		   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
														   ...
														   <div class="item-wrap">
															  <div class="item-image">
																	 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
																	 <img class="first_image" src="<c:url value='/assets/images/product/larg/demo7.jpg' />" alt="Product demo" /> 
																	 </a>
																	 <div class="item-btn">
																		<div class="box-inner">
																		   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
														   ...
														   <div class="item-wrap">
															  <div class="item-image">
																	 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
																	 <img class="first_image" src= "<c:url value='/assets/images/product/larg/demo8.jpg' />" alt="Product demo" /> 
																	 </a>
																	 <div class="item-btn">
																		<div class="box-inner">
																		   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
														   ...
														   <div class="item-wrap">
															  <div class="item-image">
																	 <a class="product-image no-touch" href="#" title="Ipad Air and iOS7">
																	 <img class="first_image" src= "<c:url value='/assets/images/product/larg/demo10.jpg' />" alt="Product demo" /> 
																	 </a>
																	 <div class="item-btn">
																		<div class="box-inner">
																		   <a title="Add to wishlist" href="#" class="link-wishlist">&nbsp;</a>
